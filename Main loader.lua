...
function createToggleButton()
    ...
    if screenGui and toggleButton then return end
...
task.spawn(function()
    while true do
        ...
        if uiEnabled then
            ...
            if playerGui and (not screenGui or not screenGui.Parent or not toggleButton) then
                destroyToggleButton()
                createToggleButton()
            end
        end
...
local shared = odh_shared_plugins
shared.load_from_github_url("/B6O6S/Better-ODH/blob/main/Part 2")
